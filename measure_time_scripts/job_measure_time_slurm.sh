...
#SBATCH --mem 5                    # memory pool for all cores
...
#SBATCH --mail-type=END,FAIL,TIME_LIMIT_50,TIME_LIMIT_80,TIME_LIMIT_90        # notifications for job done & fail
...
module load R
# Run R script
Rscript --vanilla measure_time_scripts/measure_time.R $m $r $ntrees